...
-   实现防抖效果：
    ...
    17.   `return{`
    18.   `get(){`
    19.   `track() //告诉Vue这个value值是需要被“追踪”的`
    20.   `return value`
    21.   `},`
    22.   `set(newValue){`
...
-   什么是Teleport？—— `Teleport` 是一种能够将我们的<strong style="color:#DD5145">组件html结构</strong>移动到指定位置的技术。
    ...
    3.   `<div class="dialog">`
    4.   `<h3>我是一个弹窗</h3>`
    5.   `<button [@click](https://github.com/click "@click")="isShow = false">关闭弹窗</button>`
    6.   `</div>`
    7.   `</div>`
    8.  `</teleport>`
...
-   Vue 2.x 有许多全局 API 和配置。
    ...
    -   例如：注册全局组件、注册全局指令等。
        ...
        4.   `count: 0`
        5.   `}),`
        6.   `template: '<button [](https://github.com/click "@click")[@click](https://github.com/click "@click")="count++">Clicked { { count } } times.</button>'`
        7.  `})`
